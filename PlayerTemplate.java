...
public class PlayerTemplate {
    ...
    public void loop() {
        ...
        if (cur_wp == null) { ; }
            ...
            System.out.println("player thread destination:: " + goal_coords[0]+","+goal_coords[1]+","+goal_coords[2]);
            System.out.println("player thread pos:: "+ + my_coords[0]+","+my_coords[1]+","+my_coords[2]);
